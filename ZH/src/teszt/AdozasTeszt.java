...
public class AdozasTeszt {
	public static void main(String args[]) throws IOException {
		...
		for(int i=0; i<csKedvezmenyTomb.length; i++){
			System.out.println("Gyermekek szama: ");
		...
		System.out.println("A legmagasabb kedvezmeny: "+legnagyobbCsKedvezmeny.toString());
		...
		System.out.println("A 3 gyerekesek, nagycsaladosok szama: "+haromGyerekesek);
	}
}
